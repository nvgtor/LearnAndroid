package app.nvgtor.com.leanrning.view.threeD.threeDSliding;
 ...
 * 学习自郭霖，博客链接
 * http://blog.csdn.net/guolin_blog/article/details/10471245
 */
public class ThreeDSlidingActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.threed_sliding_layout);
        ...
        contentListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ThreeDSlidingActivity.this, text, Toast.LENGTH_SHORT).show();
            }
        });
}
}
