package app.nvgtor.com.leanrning.customViews.CheckBoxSample;
...
/**
 * Created by nvgtor on 2016/4/15.
 * learn from http://www.jianshu.com/p/85dc6bf9ffac
 */
public class CheckBoxSample extends View implements Checkable{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkIconPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        checkIconPaint.setColor(0);
        checkIconPaint.setStyle(Paint.Style.STROKE);
        checkIconPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
    ...
    public void setVisibility(int visibility) {
        ...
        if (visibility == VISIBLE && drawBitmap == null) {
            ...
            bgCanvas = new Canvas(drawBitmap);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        checkIconPaint.setStrokeWidth(size);
        ...
        bgPaint.setColor(bitmapColor);

        bgCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, rad, bgPaint);
        bgCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, rad * (1 - bitmapProgress), eraserPaint);
        ...
        checkCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, rad * (1 - checkProgress), checkIconPaint);
